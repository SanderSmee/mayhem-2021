...
class CiCdGod extends Hero {
    ...
    public CiCdGod() {
        super("CI/CD god", 300, 200, "", 10, 0, 20, List.of(
            ...
            new Skill(3, "infraascode", "", -25, 1500, 10_000, 7500, 35, resistance, all),
            new Skill(4, "multicloud", "", -15, 1500, 0, 15_000, -15, resistance, all),
            new Skill(5, "greenflied", "", 0, 100, 120_000, 0, 200, power, self)
        ));
    }
}
